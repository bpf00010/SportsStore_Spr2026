...
{
    public class IndexForCustomerModel : PageModel // where is the pagemodel that index model inher
    {
        private readonly IProductRepository productRepository;

        public IndexForCustomerModel(IProductRepository productRepository)
        {
